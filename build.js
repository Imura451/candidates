...
const FLAGS = {
  ...
  CN: `<svg viewBox="0 0 30 20" role="img" aria-label="中国"><rect width="30" height="20" fill="#EE1C25"/><g fill="#FFFF00"><path d="${STAR}" transform="translate(5 5) scale(3)"/><path d="${STAR}" transform="translate(10 2) rotate(23) scale(1)"/><path d="${STAR}" transform="translate(12 4) rotate(46) scale(1)"/><path d="${STAR}" transform="translate(12 7) rotate(70) scale(1)"/><path d="${STAR}" transform="translate(10 9) rotate(21) scale(1)"/></g></svg>`,
  UZ: `<svg viewBox="0 0 30 20" role="img" aria-label="ウズベキスタン"><rect width="30" height="20" fill="#fff"/><rect width="30" height="6.4" fill="#0099B5"/><rect y="13.6" width="30" height="6.4" fill="#1EB53A"/><rect y="6.4" width="30" height="0.4" fill="#CE1126"/><rect y="13.2" width="30" height="0.4" fill="#CE1126"/><circle cx="4.4" cy="3.2" r="2.3" fill="#fff"/><circle cx="5.3" cy="3.2" r="2.0" fill="#0099B5"/><g fill="#fff"><path d="${STAR}" transform="translate(11.6 1.3) scale(0.62)"/><path d="${STAR}" transform="translate(13.4 1.3) scale(0.62)"/><path d="${STAR}" transform="translate(15.2 1.3) scale(0.62)"/><path d="${STAR}" transform="translate(9.8 3.1) scale(0.62)"/><path d="${STAR}" transform="translate(11.6 3.1) scale(0.62)"/><path d="${STAR}" transform="translate(13.4 3.1) scale(0.62)"/><path d="${STAR}" transform="translate(15.2 3.1) scale(0.62)"/><path d="${STAR}" transform="translate(8.0 4.9) scale(0.62)"/><path d="${STAR}" transform="translate(9.8 4.9) scale(0.62)"/><path d="${STAR}" transform="translate(11.6 4.9) scale(0.62)"/><path d="${STAR}" transform="translate(13.4 4.9) scale(0.62)"/><path d="${STAR}" transform="translate(15.2 4.9) scale(0.62)"/></g></svg>`,
